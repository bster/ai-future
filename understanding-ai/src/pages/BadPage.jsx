...
export default function BadPage() {
  return (
    <div>
      ...
      <p style={s.p}>AI has no lived experience. No embodied knowledge. No genuine relationships. Nothing at stake.</p>
      ...
      <p style={s.p}>This is not a limitation that scaling solves. It is the structural difference between something that has read every account of grief ever written and something that has actually grieved. The accounts make the system fluent. They do not make it a participant. When an AI writes movingly about loss, what is happening is that it is recombining the patterns of human writing about loss. The eloquence is real. The witness is not.</p>
