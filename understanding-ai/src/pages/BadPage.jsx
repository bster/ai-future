...
import { Video, Li, DQ, TryIt, SectionBadge, BoxLabel, GoDeeper, InternalLink } from "../components/Shared.jsx";
...
export default function BadPage() {
  return (
    <div>
      ...
      <p style={s.p}><strong>Capability ceiling.</strong> Whether today's architectures can eventually match general human reasoning is open. <InternalLink to="beliefs">Section 5</InternalLink> maps the camps; <InternalLink to="unknown">Section 8</InternalLink> names what we do not know about scaling and alignment.</p>
      <p style={s.p}><strong>Expressibility.</strong> AI learns from what humans have recorded and formalized. Some of what matters most resists that form — not because we have failed to try, but because precision is the wrong instrument. <InternalLink to="mirror">Section 7</InternalLink> develops that claim; it does not depend on solving neuroscience first.</p>
      ...
      <div style={s.box}>
        ...
        <p style={{ ...s.p, marginBottom: "8px" }}><InternalLink to="transform"><strong>Sections 4–6</strong></InternalLink> — where AI already has leverage, who believes what about where it is going, and what each future would cost or preserve.</p>
        <p style={{ ...s.p, marginBottom: "8px" }}><InternalLink to="mirror"><strong>Sections 7–8</strong></InternalLink> — philosophy of mind and technical uncertainty.</p>
        <p style={{ ...s.p, marginBottom: 0 }}><InternalLink to="liberal"><strong>Sections 9–10</strong></InternalLink> — what this means in the classroom and for the world students will enter.</p>
      </div>
      ...
      <GoDeeper refs={[
        ...
        { label: "Bender et al.: Stochastic Parrots", url: "https://dl.acm.org/doi/10.1145/3442188.3445922" },
        { label: "Mitchell: Why AI Is Harder Than We Think", url: "https://arxiv.org/abs/2104.12871" },
        { label: "Narayanan & Kapoor: AI Snake Oil (Princeton UP)", url: "https://press.princeton.edu/books/hardcover/9780691249131/ai-snake-oil" },
      ]} />
