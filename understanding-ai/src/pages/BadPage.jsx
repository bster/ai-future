...
export default function BadPage() {
  return (
    <div>
      ...
      <div style={s.note}><span style={s.noteLabel}>Go Deeper</span><Ref label="Gary Marcus: The Deep Learning Bubble" url="https://garymarcus.substack.com/p/the-deeplearning-bubble" />{" · "}<Ref label="Bender et al.: Stochastic Parrots" url="https://dl.acm.org/doi/10.1145/3442188.3445922" />{" · "}<Ref label="Mitchell: Why AI Is Harder Than We Think" url="https://arxiv.org/abs/2104.12871" />{" · "}<Ref label="Narayanan & Kapoor: AI Snake Oil (Princeton UP)" url="https://press.princeton.edu/books/hardcover/9780691249131/ai-snake-oil" /></div>
