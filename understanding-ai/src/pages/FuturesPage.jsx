...
import { Ref, DQ, TryIt, SectionBadge, Accordion, BoxLabel, InternalLink } from "../components/Shared.jsx";
...
export default function FuturesPage() {
  ...
  return (
    <div>
      ...
      <p style={s.p}><InternalLink to="mirror">Section 7</InternalLink> (The Mirror Problem) takes up the formal argument about minds and machines. Here the question is values first: what would each future cost or preserve for the things you care about?</p>
