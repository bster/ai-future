...
export default function FuturesPage() {
  ...
  return (
    <div>
      ...
      <p style={s.p}>They are presented as distinct for clarity. The actual future is almost certainly a weighted blend — Concentration during a Displacement, partial Augmentation inside Stagnation, Cultural Homogenization regardless of which technical scenario wins. The exercise is to feel each one's logic and notice which combinations frighten you most, not to pick a single winner.</p>
