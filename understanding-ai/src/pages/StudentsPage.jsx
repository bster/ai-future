...
export default function StudentsPage() {
  return (
    <div>
      ...
      <p style={s.p}>The futures in Section 6 are not abstract — they describe the world you will graduate into. Section 4 develops the economic picture; Displacement and Concentration there are political events as much as economic ones. You have standing in that conversation, and you will have more. How you understand who gains, who loses, and who governs the transition matters as much as any career choice you make now.</p>
      <div style={s.box}>
        <div style={{ position: "absolute", top: "-10px", left: "16px", background: c.canvas, padding: "0 8px", fontSize: "11px", letterSpacing: "0.1px", textTransform: "uppercase", color: c.inkMute, fontWeight: 400 }}>For Students</div>
