...
import { DQ, TryIt, SectionBadge, BoxLabel, GoDeeper, InternalLink } from "../components/Shared.jsx";
...
export default function StudentsPage() {
  return (
    <div>
      ...
      <p style={s.p}>The futures in <InternalLink to="futures">Section 6</InternalLink> are not abstract — they describe the world you will graduate into. <InternalLink to="transform">Section 4</InternalLink> develops the economic picture; Displacement and Concentration there are political events as much as economic ones. You have standing in that conversation, and you will have more. How you understand who gains, who loses, and who governs the transition matters as much as any career choice you make now.</p>
      <div style={s.box}>
        <BoxLabel>For Students</BoxLabel>
      ...
      <GoDeeper refs={[
        { label: "Scientific American: What Are AI Companions Doing to Our Mental Health?", url: "https://www.scientificamerican.com/article/what-are-ai-chatbot-companions-doing-to-our-mental-health/" },
