...
const ECONOMIC = [
  {
    ...
    content: (
      <>
        ...
        <div style={s.note}><span style={s.noteLabel}>Go Deeper</span><Ref label="Goldman Sachs: How AI Will Affect the US Labor Market" url="https://www.goldmansachs.com/insights/articles/how-will-ai-affect-the-us-labor-market" />{" · "}<Ref label="McKinsey: Generative AI and the Future of Work in America" url="https://www.mckinsey.com/mgi/our-research/generative-ai-and-the-future-of-work-in-america" />{" · "}<Ref label="Brynjolfsson, Chandar & Chen: Canaries in the Coal Mine? (Stanford, 2025)" url="https://digitaleconomy.stanford.edu/publications/canaries-in-the-coal-mine/" />{" · "}<Ref label="Anthropic Economic Index" url="https://www.anthropic.com/economic-index" />{" · "}<Ref label="Acemoglu: The Simple Macroeconomics of AI (NBER, 2024)" url="https://www.nber.org/papers/w32487" />{" · "}<Ref label="Kate Crawford: Atlas of AI (Yale UP, 2021)" url="https://katecrawford.net/atlas" /></div>
...
export default function TransformPage() {
  ...
  return (
    <div>
      ...
      <p style={s.p}><a href="#liberal" style={{ color: c.primary, textDecoration: "none" }}>Section 9</a> argues that judgment, interpretation, and taste may be what survives automation — and that the argument may be self-serving. That debate belongs there; the economic picture here only sets the stakes.</p>
