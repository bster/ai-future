export const TERMS = [
  ...
  { letter: "C", term: "Constitutional AI", definition: "Anthropic's approach to training AI assistants by giving the model a set of principles (a \"constitution\") and having it critique and revise its own outputs according to those principles, rather than relying solely on human feedback for every output. Designed to make value alignment more scalable and transparent." },
  ...
  // J
  { letter: "J", term: "Jevons Paradox", definition: "The economic observation that when a resource becomes more efficient to use, total consumption of that resource often rises rather than falls — because lower cost per unit leads to more use cases and more demand. Originally described for coal and steam engines by 19th-century economist William Stanley Jevons. Applied to AI: if writing software or performing legal analysis becomes cheap, the result may be more software and more legal analysis rather than fewer jobs. Whether the analogy holds for labor markets is contested." },
  ...
  // R
  { letter: "R", term: "Reasoning model", definition: "An AI model trained to generate explicit chains of thought — intermediate reasoning steps — before giving a final answer. OpenAI's o-series and similar models (Gemini Thinking, Claude's extended thinking mode) demonstrate significantly improved performance on math, formal logic, and multi-step planning compared to standard LLMs. The chain of thought is not always accurate or complete, but structuring the process this way reliably improves hard-problem performance." },
  ...
  // S
  { letter: "S", term: "Scaling laws", definition: "Empirical relationships discovered by AI researchers showing that model performance improves predictably as compute, data, and model size increase — following mathematical power laws. Scaling laws are the foundation of the bet that bigger models keep getting better, and the empirical basis for the largest training runs. Whether these laws continue to hold at frontier scale, or plateau, is one of the central open questions in AI development." },
